          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            ...
            <div className="space-y-6">
              <div className="glass-card p-6 space-y-4">
                ...
                <p className="text-slate-400 leading-relaxed">
                  With hands-on experience in <span className="text-primary font-semibold">React.js, Python, Power BI</span>,
                  and database technologies, I bridge the gap between beautiful user interfaces and
                  data-driven decision making. I've completed industry-recognized simulations from
